...
import { BringPokes, bringTypes, clearHome } from "../../redux/actions";
...
function Home() {
  ...
  const currentsPoke = allPokemons.slice(indexOfFirstPoke, indexOfLastPoke);
      ...
      {original.length > 0 && !loader ? (
        notFound.length === 0 && allPokemons.length > 0 ? (
          ...
          <div className="loaderHome">
            ...
            <img
              src="https://media4.giphy.com/media/jJO1Bwuch5orK/giphy.gif?cid=ecf05e47uf4ia4e52epwpizigvuitw987bumkkeimfgczdaa&rid=giphy.gif&ct=g"
              alt="travolta"
            />
          </div>
        )
